...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$details = trim(filter_input(INPUT_POST,"additional-details",FILTER_SANITIZE_SPECIAL_CHARS));
	...
	if (!isset($errorMessage) && !PHPMailer::validateAddress($email)) {
	...
	if (!isset($errorMessage)) {
		...
		$appPass = file_get_contents('../app-pass.txt');
		//To Do: Send Email
		$mail = new PHPMailer;
			...
			<form action="suggest.php" method="post">
				<table>
					...
					<tr>
						...
						<td><textarea name="additional-details" id="additional-details"><?php echo htmlspecialchars($details); ?></textarea></td>
					</tr>
